...
require (
	...
	github.com/eko/gocache/lib/v4 v4.1.6-0.20231209210640-002c243623a2 // indirect
	github.com/eko/gocache/store/go_cache/v4 v4.2.1 // indirect
	github.com/eko/gocache/store/redis/v4 v4.2.2-0.20231209210640-002c243623a2 // indirect
	github.com/eko/gocache/store/ristretto/v4 v4.2.2-0.20231209210640-002c243623a2 // indirect
